...
if __name__ == '__main__':
    ...
    #################################
    ## Check the Bugs Distribution ##
    #################################

    # We need to refine the keywords in order to minimize the selected keywords

    # Open Google Doc
    # Read the Commit
    # 1. Calculate the Coverage for each keyword
    # 2. Gathering all the words in the selected bugs and get new keywords